    ...
    data() {
        return {
            meetups: {
                ruby: {
                    name: "YEGrb",
                    logo: ("../assets/logos/ruby-240px.png"),
                ...
                javascript: {
                    name: "Exchange.js",
                    logo: ("../assets/logos/JavaScript-logo-240px.png"),
                ...
                edmontonPy: {
                    name: "Edmonton.Py",
                    logo: ("../assets/logos/python-logo.svg"),
                ...
                dotNet: {
                    ...
                    logo: ("../assets/logos/dotNet_logo.png"),
                ...
                weeklydevchat: {
                    ...
                    logo: ("../assets/logos/weeklydevchat-logo.svg"),
