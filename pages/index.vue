<template>
    <div>
        <div class="relative py-8 bg-white overflow-hidden max-w-7xl mx-auto sm:px-4">
            <div class="relative mx-8 sm:mx-12 pb-8 lg:my-4 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div class="relative">
                    <h3 class="text-3xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">
                        Dev Edmonton Society
                    </h3>
                    <h4 class="text-lg leading-8 font-bold text-gray-900 tracking-tight sm:text-lg sm:leading-9">
                ...
                <div class="mt-10 -mx-4 relative lg:mt-0">
                    <div class="slack-content relative p-4 text-center">
                        <a href="#about-our-slack">
                            ...
                            <img class="w-64 m-auto" src="/assets/logos/Slack_RGB.svg" alt="slack logo" />
                        </a>
                        <a href="#about-our-slack">
                ...
                <div class="mt-12 grid gap-5 max-w-lg mx-auto lg:grid-cols-3 lg:max-w-none">
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-full object-cover" src="~/assets/homepage/meetups-and-events.jpg"
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-full object-cover" src="~/assets/homepage/connect-community.jpg"
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-full object-cover" src="~/assets/homepage/provide-a-platform.jpg"
        ...
        <div class="relative bg-grey-000 pt-8 -mt-8 pb-16 px-4 sm:px-6 lg:pt-12 lg:px-8">
            ...
            <div class="relative max-w-7xl mx-auto">
                ...
                <div class="mt-12 grid gap-5 max-w-lg mx-auto lg:grid-cols-3 lg:max-w-none">
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-full object-cover" src="~/assets/homepage/get-involved-dev.jpg"
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1 flex flex-col">
                                <div class="block flex-grow">
                                    ...
                                    <p class="mt-3 text-base leading-6 text-gray-500">
                                        <a class="text-brand-primary"
                                            href="https://join.slack.com/t/devedmonton/shared_invite/zt-1hqylgb8i-pKr5nUmRwOJwdLHVce0rXg">Get
                                            started by joining our Slack</a>
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img class="h-48 w-full object-cover" src="~/assets/homepage/get-involved-meetups.png"
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div class="flex-1 flex flex-col">
                                ...
                                <div class="flex justify-center mt-4">
                                    <a href="mailto:board@devedmonton.com?subject=Supporting%20Dev%20Edmonton%20Society"
                                        target="_blank" rel="noopener noreferrer">
